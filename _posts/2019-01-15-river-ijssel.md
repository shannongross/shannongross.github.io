...
fig-caption: exploratory modeling for flood policy # Add figcaption (optional)
...
<br>
![Gelderland dike policy](../assets/img/dike.png)
<br>
...
<br>
![XLRM exploratory modeling](../assets/img/gelderland_xlrm.png)
<br>
